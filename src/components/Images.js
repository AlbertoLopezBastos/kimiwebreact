...
const Images = {
  ...
  baby: [baby],
  babyModal: [baby2],
  sanitariaClasica: [sanitariaClasica],
  sanitariaClasicaModal: [sanitariaClasica2,sanitariaClasica3,sanitariaClasica4,sanitariaClasica5,sanitariaClasica6,sanitariaClasica7,sanitariaClasica8],
  sanitariaDeluxe: [sanitariaDeluxe],
  sanitariaDeluxeModal: [sanitariaDeluxe2],
  nihon: [nihon],
  nihonModal: [nihon2],
  miryoku: [miryoku],
